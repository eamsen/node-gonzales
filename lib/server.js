...
var Proxy = function(options) {
  ...
  var enableImageCompression = true; // TODO: move me
  ...
  function handleRequest(request, response) {
    ...
    var forwardRequest = http.request(httpOpts, function(forwardResponse) {
      ...
      // and send it
      if (enableImageCompression && (forwardResponse.headers['content-type'] == 'image/jpeg'
                                      || forwardResponse.headers['content-type'] == 'image/png'))
      {
        var path = temp.path();
